...
import ruolan.com.cnliving.widget.UserInfoDialog;
...
public class TitleView  extends LinearLayout {
    ...
    public class WatcherAdapter extends RecyclerView.Adapter {
        ...
        private List<TIMUserProfile> watcherList = new ArrayList<>();
        private Map<String , TIMUserProfile> watcherMap = new HashMap<>();
